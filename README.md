# KhulnaSoft Discussion Forum Theme
discuss.khulnasoft.com uses this custom theme. Changes made to this repo are subsequently imported into the running server.
